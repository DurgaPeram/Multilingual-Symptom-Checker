...
# Load datasetss
symptoms_df = pd.read_csv('C:/Users/user/Desktop/MINOR 1/diseases_and_symptoms.csv', on_bad_lines='skip')
descriptions_df = pd.read_csv('C:/Users/user/Desktop/MINOR 1/disease_descriptions.csv', on_bad_lines='skip')
